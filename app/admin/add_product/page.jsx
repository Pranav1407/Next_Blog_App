  ...
  return (
    <>
      <form className='pt-5 px-5 sm:pt-12 pl-16' onSubmit={onSubmitHandler}>
        ...
        <textarea name='description' onChange={onChangeHandler} value={data.description} className='w-full sm:w-[500px] mt-4 px-4 py-3 border resize-none' type='text' placeholder='write content here...' rows={6} required />
        <p className='text-xl mt-4'>Blog Category</p>
        <select name='category' onChange={onChangeHandler} value={data.category} className='w-40 mt-4 px-4 py-3 border text-gray-500'>
          <option value="Startup">Startup</option>
          <option value="Technology">Technology</option>
          <option value="Lifestyle">Lifetstyle</option>
        </select>
        <br />
